...
class Layer():
    ...
    def __line_between_two_neurons(self, neuron1, neuron2):
        ...
        line = pyplot.Line2D((neuron1.x - x_adjustment, neuron2.x + x_adjustment), (neuron1.y - y_adjustment, neuron2.y + y_adjustment), 0.5)
    ...
    def draw(self, layerType=0):
        ...
        if layerType == 0:
            ...
            pyplot.text(x_text, self.y, 'Layer '+str(layerType), fontsize = 12)
...
class NeuralNetwork():
    ...
    def draw(self):
        ...
        pyplot.savefig("../wrt/NeuNetNorm/architect.png")
...
arch = np.full([int(AI.layer/AI.neurons_per_layer)], AI.neurons_per_layer)
arch = np.append(arch, 1)
network = DrawNN(arch)
network.draw()
